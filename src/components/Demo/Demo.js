			...
			<form className='Demo' onSubmit={this.handleSubmitJwtAuth}>
				...
				<fieldset>
					...
					<div className='username'>
						<label htmlFor='DemoName'>Username:</label>
						<input required name='username' defaultValue='DemoAccount' id='DemoName' />
					</div>
					<div className='password'>
						<label htmlFor='DemoPassword'>Password:</label>
						<input required name='password' type='password' defaultValue='Password123!' id='DemoPassword' />
					</div>
